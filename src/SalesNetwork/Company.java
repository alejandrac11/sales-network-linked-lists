package SalesNetwork;
	...
	Company(String v1, float v2, float v3, float v4) {
			name 							= v1;
	...
	void allNetworkBiggerCalculation() {
		...
		System.out.println("Biggest Calculation: " + bigger);
	}
	
	void allNetWorkSmallerCalculation() {
		SellerNode tmp = sellers.head;
		...
		System.out.println("Minor Calculation: " + small);
	}
